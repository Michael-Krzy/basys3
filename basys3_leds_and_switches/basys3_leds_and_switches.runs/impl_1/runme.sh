...
HD_PWD='C:/Users/Michael/basys3/basys3_leds_and_switches/basys3_leds_and_switches.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sw_and_leds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sw_and_leds.tcl -notrace
