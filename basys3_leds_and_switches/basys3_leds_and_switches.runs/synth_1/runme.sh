...
HD_PWD='C:/Users/Michael/basys3/basys3_leds_and_switches/basys3_leds_and_switches.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sw_and_leds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sw_and_leds.tcl
